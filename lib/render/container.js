...
container.prototype.getAvailableWidth = function() {
  ...
  return _.floor(this.width - this.margins.right - this.margins.left - this.currentLine.width, precision);
};
...
container.prototype.getAvailableHeight = function() {
  ...
  return _.floor(this.height - this.margins.top - this.margins.bottom - linesHeight, precision);
};
