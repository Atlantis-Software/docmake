...
var document = function(options, doc) {
  ...
  for (var font in options.fonts) {
    ...
    this.doc.registerFont(font + '-normal', fontDef.normal);
    this.doc.registerFont(font + '-bold', fontDef.bold);
    this.doc.registerFont(font + '-italics', fontDef.italics);
    this.doc.registerFont(font + '-bolditalics', fontDef.bolditalics);
  }
};
